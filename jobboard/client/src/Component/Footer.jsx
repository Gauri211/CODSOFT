        ...
        <Container as={Stack}  maxW={'6xl'} py={10}>
          <SimpleGrid
            ...
            <Stack align={'flex-start'}>
              ...
              <Link color='white' href={'#'}>Mugs</Link>
              <Link color='white' href={'#'}>Keychains</Link>
              <Link color='white' href={'#'}>T-shirts</Link>
              <Link color='white' href={'#'}>Frames</Link>
              <Link color='white' href={'#'}>Wallets</Link>
              <Link color='white' href={'#'}>bags</Link>
              <Link color='white' href={'#'}>Tags</Link>
              <Link color='white' href={'#'}>& more</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Services</ListHeader>
              <Link color='white' href={'#'}>My Account</Link>
              <Link color='white' href={'#'}>My Cart</Link>
              <Link color='white' href={'#'}>Bulk orders</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Contact us</ListHeader>
              <Link color='white' href={'#'}><Stack direction={'row'} alignItems={'center'}>
                <Box>
